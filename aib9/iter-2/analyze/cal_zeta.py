...
# load traj
#traj = md.load("wt_metad_ld1_aib9_400K_height_0.7_bf_8_sigma_0.55_wrapped.xtc", top=topol, atom_indices=topol.select("protein"))
traj = md.load("concat_wrapped.xtc", top=topol, atom_indices=topol.select("protein"))
